    ...
    val requestPermissionLauncher =
        registerForActivityResult(
            ...
            if (isGranted){
                ...
                Toast.makeText(this,"Для работы приложения необходимо выдать разрешение на работу с геолокацией в настройках",Toast.LENGTH_LONG).show()
            }
        }
                ...
                viewModel.uiState.collect{
                    ...
                    when(it){
                        ...
                        is UiState.Success -> {
                            ...
                            val calendar = Calendar.getInstance()
                            Log.d("qwerty",it.weather.dt.toString())
                            calendar.timeInMillis = it.weather.dt*1000
                            binding.date.text = "Сегодня в ${calendar.get(Calendar.HOUR_OF_DAY)}:00"
